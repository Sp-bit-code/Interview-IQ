...
const interviewIqLogo =
  "https://api.iconify.design/lucide:mic-2.svg?color=%23ffffff";

const aiLogo =
  "https://api.iconify.design/lucide:brain-circuit.svg?color=%23ffffff";

const interviewLogo =
  "https://api.iconify.design/lucide:messages-square.svg?color=%23ffffff";

const ragLogo =
  "https://api.iconify.design/lucide:book-open-check.svg?color=%23ffffff";

const resumeLogo =
  "https://api.iconify.design/lucide:file-check-2.svg?color=%23ffffff";

const flashcardLogo =
  "https://api.iconify.design/lucide:layers-3.svg?color=%23ffffff";

const uploadLogo =
  "https://api.iconify.design/lucide:upload-cloud.svg?color=%23ffffff";
...
const dashboardLogo =
  "https://api.iconify.design/lucide:layout-dashboard.svg?color=%23ffffff";

const logoutLogo =
  "https://api.iconify.design/lucide:log-out.svg?color=%23ffffff";
...
const instagramLogo =
  "https://api.iconify.design/simple-icons:instagram.svg?color=%23ffffff";

const emailLogo =
  "https://api.iconify.design/lucide:mail.svg?color=%23ffffff";

const userLogo =
  "https://api.iconify.design/lucide:user-round.svg?color=%23ffffff";
  ...
  return (
    <div className="landing-page">
      ...
      <header className="landing-header">
        <Link to="/" className="landing-logo">
          <div className="landing-logo-icon">
            <Icon src={interviewIqLogo} alt="InterviewIQ" size={21} />
          </div>
          ...
          {!user ? (
            ...
            <>
              <Link
                ...
                className="landing-nav-link landing-dashboard-link"
              >
                <Icon src={dashboardLogo} alt="Dashboard" size={17} />
                <span>Dashboard</span>
              </Link>
              ...
              <button
                ...
                className="landing-logout-btn"
              >
                <Icon src={logoutLogo} alt="Logout" size={17} />
                <span>Logout</span>
              </button>
      ...
      <main className="landing-main">
        ...
        <section className="landing-hero">
          <div className="landing-hero-left">
            <div className="landing-ai-badge">
              <Icon src={aiLogo} alt="AI" size={17} />
              <span>AI Interview Practice + RAG Study Assistant</span>
            </div>
            ...
            <div className="landing-hero-actions">
              <Link to="/setup" className="landing-primary-action">
                <Icon src={interviewLogo} alt="Start Interview" size={21} />
                <span>Start Interview Practice</span>
                <Icon
                  src={reportLogo}
                  alt="Arrow"
          ...
          <div className="landing-hero-right">
            <div className="landing-hero-dashboard-card">
              ...
              <div className="landing-dashboard-card-footer">
                <Icon src={aiLogo} alt="AI Tools" size={18} />
                <span>Choose one tool and start improving today.</span>
              </div>
            </div>
          </div>
        ...
        <section className="landing-stats-section">
          ...
          <StatCard icon={ragLogo} title="RAG" text="Study from Notes" />

          <StatCard icon={resumeLogo} title="JD" text="Resume Matching" />
      ...
      <footer ref={developerRef} id="developers" className="landing-footer">
        <div className="landing-footer-content">
          ...
          <div className="landing-footer-dev">
            ...
            <div className="landing-developer-card">
              <div className="landing-developer-avatar">
                <Icon src={userLogo} alt="Sparsh Srivastava" size={34} />
              </div>
              ...
              <div className="landing-developer-info">
                ...
                <div className="landing-footer-socials">
                  ...
                  <a
                    ...
                    aria-label="Instagram"
                  >
                    <Icon src={instagramLogo} alt="Instagram" size={19} />
                    Instagram
                  </a>

                  <a href="mailto:sparshsrivastava@example.com">
                    <Icon src={emailLogo} alt="Email" size={19} />
                    Email
                  </a>
                </div>
              </div>
...
function ServiceCard({
  ...
  return (
    <div className="landing-service-card">
      <div className="landing-service-card-top">
        <div className="landing-service-icon">
          <Icon src={icon} alt={title} size={44} />
        </div>
      ...
      <div className="landing-service-points">
        {points.map((point) => (
          <div className="landing-service-point" key={point}>
            <Icon src={checkLogo} alt="Point" size={17} />
            <span>{point}</span>
          </div>
        ))}
      </div>
      ...
      <Link to={to} className="landing-service-btn">
        <span>{buttonText}</span>
        <Icon src={reportLogo} alt="Open" size={18} />
      </Link>
    </div>
  );
}
  ...
  return (
    <div className="landing-workflow-card">
      <div className="landing-workflow-card-top">
        ...
        <div className="landing-workflow-icon">
          <Icon src={icon} alt={title} size={34} />
        </div>
      </div>
