  ...
  const handleCallFinished = useCallback(
    async (finalMessages = []) => {
      ...
      try {
        ...
        console.log(
          " Interview session saved to Supabase with transcript + camera score."
        );
      } catch (err) {
        ...
        <section className="interview-room-left">
          ...
          <div className="interview-room-controls">
            ...
            <button
              ...
              className={`interview-mute-btn ${!cameraReady ? "muted" : ""}`}
            >
              {cameraReady ? <Video size={20} /> : <VideoOff size={20} />}
          ...
          <div className="interview-transcript-card">
            ...
            {messages.length === 0 ? (
              <div className="interview-empty-transcript">
                ...
                <p>
                  Start the interview. Final transcripts will appear here
                  after each spoken message.
                </p>
              </div>
            ) : (
